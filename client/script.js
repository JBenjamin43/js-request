...
// CODE HERE
    ...
    sayHelloButton.style.color = "black"
     ...
     sayHelloButton.addEventListener('mouseout', backColor)
...
const repeatMyParam = () => {
    let request = axios.get('http://localhost:3000/repeat/lion')
    request.then(res =>{
...
const getRequest = () => {
    axios.get('http://localhost:3000/query-test?lions&benny')
    .then(res => {
        console.log(res.data)
    })
}
